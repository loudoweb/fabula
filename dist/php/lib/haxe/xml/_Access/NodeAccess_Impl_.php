...
final class NodeAccess_Impl_ {
	...
	public static function resolve ($this1, $name) {
		#C:\haxeToolkit_415\haxe\std/haxe/xml/Access.hx:28: characters 3-43
		$x = $this1->elementsNamed($name)->next();
		#C:\haxeToolkit_415\haxe\std/haxe/xml/Access.hx:29: lines 29-32
		if ($x === null) {
			#C:\haxeToolkit_415\haxe\std/haxe/xml/Access.hx:30: characters 4-81
			$xname = null;
			#C:\haxeToolkit_415\haxe\std/haxe/xml/Access.hx:30: characters 16-80
			if ($this1->nodeType === \Xml::$Document) {
				#C:\haxeToolkit_415\haxe\std/haxe/xml/Access.hx:30: characters 4-81
				$xname = "Document";
			} else {
				#C:\haxeToolkit_415\haxe\std/haxe/xml/Access.hx:30: characters 67-80
			...
			#C:\haxeToolkit_415\haxe\std/haxe/xml/Access.hx:31: characters 4-9
			throw Exception::thrown(($xname??'null') . " is missing element " . ($name??'null'));
		}
		#C:\haxeToolkit_415\haxe\std/haxe/xml/Access.hx:33: characters 10-23

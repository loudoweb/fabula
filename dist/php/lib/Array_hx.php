...
final class Array_hx implements \JsonSerializable, \Countable, \IteratorAggregate, \ArrayAccess {
	...
	public static function wrap ($arr) {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:267: characters 3-23
		$a = new Array_hx();
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:268: characters 3-14
		$a->arr = $arr;
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:269: characters 3-31
		$a->length = count($arr);
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:270: characters 3-11
		return $a;
	}
	...
	public function count () {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:257: characters 3-16
		return $this->length;
	}
	...
	public function getIterator () {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:250: characters 3-38
	...
	public function jsonSerialize () {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:263: characters 3-13
		return $this->arr;
	}
	...
	public function offsetExists ($offset) {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:212: characters 3-25
	...
	public function &offsetGet ($offset) {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:218: lines 218-222
		try {
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:219: characters 4-22
			return $this->arr[$offset];
		} catch(\Throwable $_g) {
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:221: characters 4-15
			return null;
		}
	}
	...
	public function offsetSet ($offset, $value) {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:228: lines 228-233
		if ($this->length <= $offset) {
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:229: characters 13-19
			$_g = $this->length;
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:229: characters 22-32
			$_g1 = $offset + 1;
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:229: lines 229-231
			while ($_g < $_g1) {
				#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:229: characters 13-32
				$i = $_g++;
				#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:230: characters 5-18
				$this->arr[$i] = null;
			}
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:232: characters 4-23
			$this->length = $offset + 1;
		}
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:234: characters 3-22
		$this->arr[$offset] = $value;
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:235: characters 3-35
		return $value;
	}
	...
	public function offsetUnset ($offset) {
		#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:241: lines 241-244
		if (($offset >= 0) && ($offset < $this->length)) {
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:242: characters 4-39
			array_splice($this->arr, $offset, 1);
			#C:\HaxeToolkit\haxe\std/php/_std/Array.hx:243: characters 4-12
			--$this->length;
		}
	}
